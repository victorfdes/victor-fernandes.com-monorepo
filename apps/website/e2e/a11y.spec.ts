...
// `/design` is in the list because it is the only surface rendering every token and class at
// once, so axe composites the whole palette against the real page in one pass.
